...
import com.elsobreviviente.servicios.persistence.TipoServicio;
...
public class ServicioService {
	...
	public List<Servicio> findByNombreServicioStartingWithIgnoreCase ( String cadena ){
		return serviceRepository.findByNombreServicioStartingWithIgnoreCase(cadena);
	}
...
/*
String codigoTipoServicio =   servicioNewDto.getCodigoTipoServicio();
TipoServicio tipoServicio = tipoServicioRepository.getReferenceById(codigoTipoServicio); //convierte una cadena string que es la clave a ENTITY
